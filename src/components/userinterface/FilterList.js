...
export default function FilterList(props) {
    ...
    return categoryList?.map((item) => {
      return (
        ...
        >
          ...
          >
            <div style={{ color: "#000", fontWeight: "lighter", fontSize: 12 }}>
              {item.categoryname}
            </div>
          </AccordionSummary>
  ...
  const handleshowsubcategoryproduct = (item) => {
    {
      navigate("/filterpage/null", {
        state: { subcategoryid: item.subcategoryid },
      });
    }
  };
  ...
  const showAllSubCategory = () => {
    return subCategoryList?.map((item) => {
      return (
        <MenuItem
          onClick={() => handleshowsubcategoryproduct(item)}
      ...
      return (
        ...
        >
          <FormGroup>
            <FormControlLabel
              control={<Checkbox />}
              style={{ color: "#000", fontWeight: "lighter", fontSize: 8 }}
  ...
  return (
    ...
    >
      ...
      <span style={{ fontWeight: "bolder", fontSize: 15, marginLeft: "5%" }}>
        Category
      </span>
